...
$(".menu").click(function() {
    ...
    if (menuBtn.className.includes("open")) $("body").css("overflow", "hidden");
...
$("main").click(function() {
    if ($(".responsivesearcher").attr("class").split(" ").length > 2) $(".responsivesearcher").toggleClass("isactivesearcher");
});
...
function changePSState(s1, s2, s3, s4) {
    ...
    if (s1 !== "none") changePSLinkStates(lastclicked, 0);
    else if (s2 !== "none") changePSLinkStates(lastclicked, 1);
    else if (s3 !== "none") changePSLinkStates(lastclicked, 2);
    else if (s4 !== "none") changePSLinkStates(lastclicked, 3);
}
...
//# sourceMappingURL=loginform.c4775257.js.map
